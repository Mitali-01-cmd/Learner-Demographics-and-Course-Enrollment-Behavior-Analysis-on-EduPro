...
# ============================================================
# FINAL MULTISELECT COLOR OVERRIDE
# ============================================================
# This override targets Streamlit's current BaseWeb multiselect
# structure with high specificity so the default red styling does
# not override the custom light design.
st.markdown("""
<style>
...
/* Covers the inner BaseWeb containers */
...
/* ===== STOP DEFAULT RED PRIMARY COLOR FROM AFFECTING TAGS ===== */
div[data-testid="stMultiSelect"] [data-baseweb="tag"][style],
div[data-testid="stMultiSelect"] [data-baseweb="tag"] *[style] {
    background-color: #E8EEF7 !important;
    color: #334155 !important;
}
